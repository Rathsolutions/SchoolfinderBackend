...
INSERT INTO School (id,school_name, latitude, longitude, school_picture) VALUES (0,'testschool','1.111','2.222','0x00');
INSERT INTO School (id,school_name, latitude, longitude, school_picture) VALUES (1,'testschool2','2.222','1.111','0xFF');
INSERT INTO School (id,school_name, latitude, longitude, school_picture) VALUES (2,'testschool3','3.333','4.444','0xAF');
INSERT INTO person_school_mapping (id,person_id, school_id, functionality) VALUES (0,(SELECT id FROM Person where prename='karl'),(SELECT id FROM School where school_name='testschool'), 'AR');
INSERT INTO person_school_mapping (id,person_id, school_id, functionality) VALUES (1,(SELECT id FROM Person where prename='karl2'),(SELECT id FROM School where school_name='testschool2'), 'MAKERSPACE');
INSERT INTO person_school_mapping (id,person_id, school_id, functionality) VALUES (2,(SELECT id FROM Person where prename='karl'),(SELECT id FROM School where school_name='testschool3'), 'AR');
